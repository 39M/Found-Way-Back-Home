...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        override public void OnInspectorGUI()
        {
            ...
            if (prevAnimType != _src.animationType)
            {
                ...
                switch (_src.animationType)
                {
                    ...
                    case DOTweenAnimationType.PunchScale:
                        _src.startValueV3 = _src.animationType == DOTweenAnimationType.PunchRotation ? new Vector3(0, 180, 0) : Vector3.one;
                    ...
                    case DOTweenAnimationType.ShakeScale:
                        _src.startValueV3 = _src.animationType == DOTweenAnimationType.ShakeRotation ? new Vector3(90, 90, 90) : Vector3.one;
                    ...
                    case DOTweenAnimationType.CameraRect:
                        _src.startValueRect = new Rect(0, 0, 0, 0);
            ...
            if (_src.animationType == DOTweenAnimationType.LocalMove)
            {
                EditorGUILayout.LabelField("如果是UI，请在下面填写相对值");
            }
        ...
        {
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.From);
            _src.startValueFloat = EditorGUILayout.FloatField(_src.startValueFloat);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.To);
        ...
        void GUIEndValueColor()
        {
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.From);
            _src.startValueColor = EditorGUILayout.ColorField(_src.startValueColor);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.To);
        ...
        void GUIEndValueV3(bool optionalTransform = false)
        {
            ...
            {
                Transform prevT = _src.startValueTransform;
                _src.startValueTransform = EditorGUILayout.ObjectField(_src.startValueTransform, typeof(Transform), true) as Transform;
                if (_src.startValueTransform != prevT && _src.startValueTransform != null)
                {
                    if (_src.GetComponent<RectTransform>() != null)
                    {
                        if (_src.startValueTransform.GetComponent<RectTransform>() == null)
                        {
                            EditorUtility.DisplayDialog("DOTween Pro", "For Unity UI elements, the target must also be a UI element", "Ok");
                            _src.startValueTransform = null;
                        }
                    }
                    else if (_src.startValueTransform.GetComponent<RectTransform>() != null)
                    {
            ...
            {
                _src.startValueV3 = EditorGUILayout.Vector3Field("", _src.startValueV3, GUILayout.Height(16));
            }
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.To);
            ...
            //if (_src.useStartTargetAsV3 && _src.startValueTransform != null && _src.target is RectTransform)
            //{
        ...
        void GUIEndValueV2()
        {
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.From);
            _src.startValueV2 = EditorGUILayout.Vector2Field("", _src.startValueV2, GUILayout.Height(16));
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.To);
        ...
        void GUIEndValueString()
        {
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.From);
            _src.startValueString = EditorGUILayout.TextArea(_src.startValueString, EditorGUIUtils.wordWrapTextArea);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.To);
        ...
        void GUIEndValueRect()
        {
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.From);
            _src.startValueRect = EditorGUILayout.RectField(_src.startValueRect);
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            GUIToOrFromButton(ToFromType.To);
        ...
        void GUIToOrFromButton(ToFromType type)
        {
            if (type == ToFromType.From)
            {
                GUILayout.Button("FROM", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            }
            else
            {
                GUILayout.Button("TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(90));
            }
            GUILayout.Space(16);
        }

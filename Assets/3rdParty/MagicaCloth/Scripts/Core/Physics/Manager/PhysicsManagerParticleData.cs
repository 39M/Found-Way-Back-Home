...
namespace MagicaCloth
{
    ...
    public class PhysicsManagerParticleData : PhysicsManagerAccess
    {
        ...
        public const uint Flag_Transform_Restore_FixedUpdate = 0x00080000; // FixedUpdateで復元する
        ...
        public struct ParticleFlag
        {
            ...
            /// <summary>
            /// このパーティクルがFixedUpdateでトランスフォームの復元を行うか判定する
            /// </summary>
            /// <returns></returns>
            public bool IsRestoreFixedUpdate()
            {
                return (flag & Flag_Transform_Restore_FixedUpdate) != 0;
            }
                    ...
                    if (funcTarget != null)
                    {
                        ...
                        if (target != null)
                        {
                            ...
                            if (flag.IsRestoreTransform() && restoreTransformIndexList[index] == -1)
                            {
                                ...
                                restoreTransformIndexList[index] = Bone.AddRestoreBone(target, lpos, lrot, flag.IsRestoreFixedUpdate());
                            }

...
namespace KartGame.KartSystems
{
    ...
    public class KartMovement : MonoBehaviour, IKartCollider, IMovable, IKartInfo
    {
        ...
        public float minDriftStartAngle = 10f;
        ...
        void Start ()
        {
            ...
            //OnDriftStarted.AddListener(() => { print("Start Drift!"); });
            //OnDriftStopped.AddListener(() => { print("Stop Drift!"); });
            ((AddativeKartModifierAsset)kart).statAdditions.grip = 40;
            ((AddativeKartModifierAsset)kart).statAdditions.topSpeed = 30;
        }

        public void SetSprintCount(float value)
        {
            ((AddativeKartModifierAsset)kart).statAdditions.grip = 40 - (value * 2);
            ((AddativeKartModifierAsset)kart).statAdditions.topSpeed = 30 - value;
        }
